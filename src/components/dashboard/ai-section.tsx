...
function AiBudgetsSection({ 
    ...
    const handlePartidaChange = async (budgetId: string, chapterName: string, partidaIndex: number, field: 'descripcion' | 'medicion' | 'unidad', value: string) => {
        ...
        // Si se cambia la descripción, también hay que actualizar la clave en userLineTotals
        if (field === 'descripcion') {
            ...
            if (newUserLineTotals[chapterName] && newUserLineTotals[chapterName][oldDescription] !== undefined) {
                ...
                delete newUserLineTotals[chapterName][oldDescription];
                 await updateDoc(doc(db, 'ia_budgets', budgetId), { userLineTotals: newUserLineTotals });
            }
        }
